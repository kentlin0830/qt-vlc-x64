...
int main(int argc, char *argv[])
{
    ...
    player* pl1 = new player("rtsp://127.0.0.1:8554/movie.mp4");
    //player* pl1 = new player("file:///C:/Users/Kent/Downloads/qtVlc-master/build/test.mp4");
    //player* pl1 = new player("test.mp4");
